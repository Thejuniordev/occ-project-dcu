...
const Methods = {
  ...
  writeEnvFile: keysToUpdate => {
    const envFile = {
      ...
      OCC_DEV_ADMIN_URL: process.env.OCC_DEV_ADMIN_URL || '',
      OCC_DEV_APP_KEY: process.env.OCC_DEV_APP_KEY || '',
      OCC_TST_ADMIN_URL: process.env.OCC_TST_ADMIN_URL || '',
      OCC_TST_APP_KEY: process.env.OCC_TST_APP_KEY || '',
